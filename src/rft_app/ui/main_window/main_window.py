...
class MainWindowKD(QMainWindow):
    ...
    def _connect_signals(self)-> None:
        ...
        self.project_sidebar.all_analyses_tree.new_view_requested.connect(lambda analysis: self._create_new_analysis_view(analysis))

    def _create_default_analysis_view(self,analysis:AnalysisObject,tab:QTabWidget|None=None,):
