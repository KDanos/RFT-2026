...
class NewViewDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        if self._has_existing_views:
            ...
            self.button_box.button(QDialogButtonBox.StandardButton.Ok).setText("Copy Existing View")
            self.button_box.button(QDialogButtonBox.StandardButton.Cancel).setText("Create Empty View")
        else:
            self.button_box = QDialogButtonBox(
                QDialogButtonBox.StandardButton.Ok
                |QDialogButtonBox.StandardButton.Cancel,
